...
public class TodosTest {
    ...
    @Test
    public void shouldFindSeveralTasksOfDifferentType() {
    ...
    @Test
    public void shouldFindOneFromTheTasksOfDifferentType() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void shouldNotFindFromTheTasksOfDifferentType() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
        ...
        String query = "Работа над ошибками";
